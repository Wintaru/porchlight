...
const POST_PAGE_COLUMNS =
  "id, slug, title, summary, body_html, status, visibility, comments_enabled, rejection_reason, published_at, author_id, author:profiles!posts_author_id_fkey(handle, display_name), post_tags(tag:tags(slug, name))";
